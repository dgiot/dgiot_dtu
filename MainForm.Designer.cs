...
#region Windows Form Designer generated code
  ...
  private void InitializeComponent() {
    ...
    this.buttonStartStop.Click +=
        new System.EventHandler(this.ButtonStartStopClick);
    //
    // textBoxLog
    //
    this.textBoxLog.BackColor = System.Drawing.Color.FromArgb(
        ((int)(((byte)(107)))), ((int)(((byte)(170)))), ((int)(((byte)(55)))));
    ...
    this.textBoxLog.TextChanged +=
        new System.EventHandler(this.textBoxLog_TextChanged);
    //
    // checkBoxReconnect
    //
    ...
    this.checkBoxReconnect.CheckedChanged +=
        new System.EventHandler(this.CheckBoxReconnectCheckedChanged);
    //
    // checkBoxDisplayHex
    //
    ...
    this.checkBoxDisplayHex.CheckedChanged +=
        new System.EventHandler(this.CheckBoxDisplayHexCheckedChanged);
    //
    // buttonClear
    //
    ...
    this.comboBoxParity.Items.AddRange(
        new object[] { "NONE", "Odd", "Even", "Mark", "Space" });
    ...
    this.comboBoxParity.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxParity_SelectedIndexChanged);
    //
    // label13
    //
    ...
    this.comboBoxStopBits.Items.AddRange(new object[] { "1", "2", "1.5" });
    ...
    this.comboBoxStopBits.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxStopBits_SelectedIndexChanged);
    //
    // comboBoxDataBits
    //
    this.comboBoxDataBits.FormattingEnabled = true;
    this.comboBoxDataBits.Items.AddRange(new object[] { "8", "7", "6", "5" });
    ...
    this.comboBoxDataBits.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxDataBits_SelectedIndexChanged);
    //
    // comboBoxBaudRate
    //
    this.comboBoxBaudRate.FormattingEnabled = true;
    this.comboBoxBaudRate.Items.AddRange(
        new object[] { "1200", "2400", "4800", "9600", "19200", "38400",
                       "57600", "115200" });
    ...
    this.comboBoxBaudRate.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxBaudRate_SelectedIndexChanged);
    //
    // labelSerialPort
    //
    ...
    this.comboBoxSerialPort.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxSerialPort_SelectedIndexChanged);
    //
    // textBoxBridgePort
    //
    ...
    this.textBoxBridgePort.TextChanged +=
        new System.EventHandler(this.TextBoxBridgePort_TextChanged);
    //
    // textBoxMqttPubTopic
    //
    ...
    this.textBoxMqttPubTopic.Text =
        "$dg/thing/{productId}/{deviceAddr}/properties/report";
    this.textBoxMqttPubTopic.TextChanged +=
        new System.EventHandler(this.TextBoxMqttPubTopic_TextChanged);
    //
    // label12
    //
    ...
    this.textBoxMqttSubTopic.Text =
        "$dg/device/{productId}/{deviceAddr}/properties";
    this.textBoxMqttSubTopic.TextChanged +=
        new System.EventHandler(this.TextBoxMqttSubTopic_TextChanged);
    //
    // label11
    //
    ...
    this.textBoxMqttPassword.TextChanged +=
        new System.EventHandler(this.TextBoxMqttPassword_TextChanged);
    //
    // label10
    //
    ...
    this.textBoxMqttUserName.TextChanged +=
        new System.EventHandler(this.TextBoxMqttUserName_TextChanged);
    //
    // label9
    //
    ...
    this.textToPayload.TextChanged +=
        new System.EventHandler(this.TextToPayload_TextChanged);
    //
    ...
    this.textBoxTcpClientLogin.TextChanged +=
        new System.EventHandler(this.TextBoxTcpClientLogin_TextChanged);
    //
    // textBoxMqttClientId
    //
    ...
    this.textBoxMqttClientId.TextChanged +=
        new System.EventHandler(this.TextBoxMqttClientId_TextChanged);
    //
    // textBoxDgiotPort
    //
    ...
    this.textBoxDgiotPort.TextChanged +=
        new System.EventHandler(this.TextBoxDgiotPort_TextChanged);
    //
    ...
    this.textBoxUDPClientLogin.TextChanged +=
        new System.EventHandler(this.TextBoxUDPClientLogin_TextChanged);
    //
    // sendBridge
    //
    ...
    this.checkBoxBridge.CheckedChanged +=
        new System.EventHandler(this.CheckBoxBridge_CheckedChanged);
    //
    // groupBox3
    //
    ...
    this.comboBoxCmdProdxy.Items.AddRange(new object[] { "ffmpeg" });
    ...
    this.comboBoxCmdProdxy.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxCmdProdxy_SelectedIndexChanged);
    //
    // label20
    //
    ...
    this.comboBoxDtuAddr.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxDtuAddr_SelectedIndexChanged);
    //
    // label30
    //
    ...
    this.textBoxDgiotSever.TextChanged +=
        new System.EventHandler(this.TextBoxDgiotSever_TextChanged);
    //
    // label22
    //
    ...
    this.textBoxOPCDACount.TextChanged +=
        new System.EventHandler(this.TextBoxOPCDACount_TextChanged);
    //
    // labelOPCDACount
    //
    ...
    this.textBoxOPCDAInterval.TextChanged +=
        new System.EventHandler(this.TextBoxOPCDAInterval_TextChanged);
    //
    // checkBoxOPCDA
    //
    ...
    this.checkBoxOPCDA.CheckedChanged +=
        new System.EventHandler(this.CheckBoxOPCDA_CheckedChanged);
    //
    // textBoxOPCDAHost
    //
    ...
    this.textBoxOPCDAHost.TextChanged +=
        new System.EventHandler(this.TextBoxOPCDAHost_TextChanged);
    //
    // labelOPCDAHost
    //
    ...
    this.textBoxOPCUATopic.Text =
        "$dg/thing/{productId}/{deviceAddr}/properties/report";
    this.textBoxOPCUATopic.TextChanged +=
        new System.EventHandler(this.TextBoxOPCUATopic_TextChanged);
    //
    // labelopcua
    //
    ...
    this.textBoxBACnetTopic.Text =
        "$dg/thing/{productId}/{deviceAddr}/properties/report";
    this.textBoxBACnetTopic.TextChanged +=
        new System.EventHandler(this.TextBoxBACnetTopic_TextChanged);
    //
    // label23
    //
    ...
    this.textBoxControlTopic.Text =
        "$dg/thing/{productId}/{deviceAddr}/properties/report";
    this.textBoxControlTopic.TextChanged +=
        new System.EventHandler(this.TextBoxControlTopic_TextChanged);
    //
    // label8
    //
    ...
    this.comboBoxBridge.Items.AddRange(
        new object[] { "SerialPort,", "TcpServer,", "BACnet,", "OPCDA,",
                       "OPCUA,", "MqttClient,", "MqttServer,", "TcpClient,",
                       "TcpServer,", "UdpClient,", "UdpServer,", "PLC,",
                       "Control,", "Access,", "SqlServer" });
    ...
    this.comboBoxBridge.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxBridge_SelectedIndexChanged);
    //
    // label7
    //
    ...
    this.textBoxAccessTopic.Text =
        "$dg/thing/{productId}/{deviceAddr}/properties/report";
    this.textBoxAccessTopic.TextChanged +=
        new System.EventHandler(this.TextBoxAccessTopic_TextChanged);
    //
    // label6
    //
    ...
    this.radioButtonMqttClient.Margin =
        new System.Windows.Forms.Padding(2, 1, 2, 1);
    ...
    this.radioButtonMqttClient.CheckedChanged +=
        new System.EventHandler(this.RadioButtonMqttClient_CheckedChanged);
    //
    ...
    this.radioButtonTcpClient.Margin =
        new System.Windows.Forms.Padding(2, 1, 2, 1);
    ...
    this.radioButtonTcpClient.CheckedChanged +=
        new System.EventHandler(this.RadioButtonTcpClient_CheckedChanged);
    //
    ...
    this.radioButtonUDPClient.Margin =
        new System.Windows.Forms.Padding(2, 1, 2, 1);
    ...
    this.radioButtonUDPClient.CheckedChanged +=
        new System.EventHandler(this.RadioButtonUDPClient_CheckedChanged);
    //
    // groupBox12
    //
    ...
    this.textBoxPLCTopic.Text =
        "$dg/thing/{productId}/{deviceAddr}/properties/report";
    this.textBoxPLCTopic.TextChanged +=
        new System.EventHandler(this.TextBoxPLCTopic_TextChanged);
    //
    // label2
    //
    ...
    this.comboBoxLogLevel.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxLogLevel_SelectedIndexChanged);
    //
    // label32
    //
    ...
    // comboBoxLan
    //
    this.comboBoxLan.DropDownStyle =
    ...
    this.comboBoxLan.SelectedIndexChanged +=
        new System.EventHandler(this.ComboBoxLan_SelectedIndexChanged);
    //
    // label33
    //
    ...
    this.treeView.AfterLabelEdit +=
        new System.Windows.Forms.NodeLabelEditEventHandler(this.AfterLabelEdit);
    this.treeView.AfterCheck +=
        new System.Windows.Forms.TreeViewEventHandler(this.TreeView_AfterCheck);
    this.treeView.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(
        this.TreeView_AfterSelect);
    this.treeView.NodeMouseDoubleClick +=
        new System.Windows.Forms.TreeNodeMouseClickEventHandler(
            this.NodeMouseDoubleClick);
    //
    // label_devcietree
    //
    ...
    this.BackColor = System.Drawing.Color.FromArgb(
        ((int)(((byte)(60)))), ((int)(((byte)(143)))), ((int)(((byte)(178)))));
